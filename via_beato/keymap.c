...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//,|---------------+-------------------+-------------------+-------------------+-------------------+-----|.   ,|-----------+---------------------------+-------------------------------+-------------------------------+-----------------------------------+-------|.
		S(KC_8), 		KC_NO, 				KC_TRNSC_NO, 		KC_NO, 				KC_NO, 				KC_NO, 		KC_NO, 		KC_HOME, 					KC_PGDN, 						KC_PGUP, 						KC_END, 							S(KC_9),
	//,|---------------+-------------------+-------------------+-------------------+-------------------+-----|.   ,|-----------+---------------------------+-------------------------------+-------------------------------+-----------------------------------+-------|.
	...
	//,|---------------+-------------------+-------------------+-------------------+-------------------+------|.  ,|-----------+---------------------------+-------------------------------+-------------------------------+-----------------------------------+-------------|.
		RESET, 			KC_F1, 				KC_F2, 				KC_F3, 				KC_F4, 				KC_F5, 		KC_F7, 		KC_F8,						KC_F9, 							KC_F12, 						KC_PSCR, 							KC_VOLU, 
	//,|---------------+-------------------+-------------------+-------------------+-------------------+------|.  ,|-----------+---------------------------+-------------------------------+-------------------------------+-----------------------------------+-------------|.
		KC_NO, 			KC_NO, 				KC_NO, 				KC_NO, 				KC_NO, 				KC_NO, 		KC_F4, 		KC_F5, 						KC_F6, 							KC_F11, 						KC_SLCK, 							KC_VOLD, 
	//,|---------------+-------------------+-------------------+-------------------+-------------------+------|.  ,|-----------+---------------------------+-------------------------------+-------------------------------+-----------------------------------+-------------|.
